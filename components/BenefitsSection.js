    ...
    <section className="benefits section">
      <div className="container benefits-grid">
        ...
        <div className="benefits-list">
          ...
          <article className="benefit-card"><h3>{isEnglish ? "Personal advice" : "Conseil personnalise"}</h3><p>{isEnglish ? "A team available to guide you according to your style, size and preferences." : "Une equipe disponible pour vous guider selon votre style, votre taille et vos envies."}</p></article>
          <article className="benefit-card"><h3>{isEnglish ? "Shipping with care" : "Expedition soignee"}</h3><p>{isEnglish ? "Your pieces are prepared with care in a refined and elegant package." : "Vos pieces sont preparees avec attention dans un ecrin sobre et elegant."}</p></article>
        </div>
      </div>
    </section>
  );
