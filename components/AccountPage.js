    ...
    <div className="account-page-body">
      <header className="site-header auth-header">
        <div className="container header-inner">
          ...
          <Link href="/#produits" className="button button-secondary auth-back-link">Retour a la boutique</Link>
        </div>
      </header>
        ...
        <section className="auth-section">
          <div className="container auth-shell">
            <div className="auth-copy">
              ...
              <h1>Connectez-vous pour poursuivre votre commande</h1>
              <p>
                Retrouvez votre selection Mady Mode, finalisez votre demande et echangez plus facilement avec la boutique.
              </p>
              <ul className="auth-benefits">
                <li>Acces a votre selection en cours</li>
                <li>Suivi simplifie de votre demande</li>
            ...
            <div className="auth-card">
              ...
              <div className="auth-footer-note">
                ...
                <Link href="/#contact">Ecrire au service client</Link>
              </div>
            </div>
          </div>
        </section>
